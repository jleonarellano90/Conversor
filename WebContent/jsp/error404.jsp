...
<div class="row">
	<div class="twelve columns" align="center">
		<h1 style="font-size: 700%; color: #333; line-height: 1.5"> Error 404 
		...
		<div align="center">
			...
			<h2 style="color: #666; line-height: 1.5;"> Página No Encontrada </h2>
			<p>La página solicitada no se pudo encontrar. Utilice el botón 
				<b>Volver</b> para regresar a donde se encontraba o regresar a 
				<a href="inicio.do">Principal</a>.
			</p>
		</div>
	</div>
</div>
